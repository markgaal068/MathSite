...
const feladatok = {
  "Az évfolyam tematikája": [
    { title: "Tematika", file: "/evfolyam11/tematika.pdf" }
  ],
  "Algebra": [
...
export default function evfolyam11() {
  return (
    <main className="p-4 md:p-8 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold text-[#33d4ff] mb-6">Feladatok 11. évfolyam számára</h1>
