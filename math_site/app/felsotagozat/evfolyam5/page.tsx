...
const feladatok = {
  "Az évfolyam tematikája": [
    { title: "Tematika", file: "/evfolyam5/tematika.pdf" }
  ],
  "Algebra": [
...
export default function evfolyam5() {
  return (
    <main className="p-4 md:p-8 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold text-[#33d4ff] mb-6">Feladatok 5. évfolyam számára</h1>
