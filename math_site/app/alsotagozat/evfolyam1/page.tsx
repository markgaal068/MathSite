...
const feladatok = {
  "Az évfolyam tematikája":[
    {title: "Tematika", file:"/evfolyam1/tematika.pdf"}
  ],
  "Algebra": [
...
export default function evfolyam1() {
  return (
    <main className="p-4 md:p-8 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold mb-6 text-[#33d4ff]">Feladatok 1. évfolyam számára</h1>
